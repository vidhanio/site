...
finally! i committed my changes and sent them up the message tube to github, where they now live ([repo](https://github.com/vidhanio/computer-science), of course licensed with the most based of licenses, agpl. repo will be private until the end of the course to prevent plagiarism. i worked hard. go away.)
